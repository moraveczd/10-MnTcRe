...
\frame{
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Pojmenován podle dánského fyzika Nielse Bohra.\footnote[frame]{\href{http://publications.iupac.org/pac/pdf/1997/pdf/6912x2471.pdf}{Names and symbols of transfermium elements}}
		\end{itemize}
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=0.3\textwidth]{img/World_Manganese_Production_2006.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Pyrolusite_botryoidal.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Piroluzyt_Wlochy.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Psilomelane-167850.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Vanadinite-Psilomelane-112809.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Rhodochrosite_Crystal.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Rhodochrosite_Pink_Form.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{itemize}
		...
		\item Manganová ruda se redukuje s železnou rudou a koksem ve vysokých nebo elektrických pecích.\footnote[frame]{\href{http://www.forexmetalminerals.com/Product.aspx?id=4}{Ferromanganese}}
...
\frame{
	...
	\begin{itemize}
		...
		\item Redukcí získáme burel, \ce{MnO2}. Mletím je snížen průměr částic na 150--250~$\mu$m, tím dojde ke zvýšení měrného povrchu a usnadnění extrakce.
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Technecium se v přírodě vyskytuje pouze ve stopových množstvích.
...
\frame{
	...
	\end{itemize}
	\begin{figure}
	\adjincludegraphics[height=0.35\textwidth]{img/Rhenium.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{.4\textwidth}
			\begin{figure}
				\adjincludegraphics[width=\textwidth]{img/Niels_Bohr.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Většina manganu se využívá ve slitinách, nejčastěji v ocelích, ale i~v~hliníkových slitinách.
		...
		\item Mangan je při výrobě ocelí nenahraditelný, slouží k fixaci síry.
		\item Zabraňuje vzniku sulfidů železa na hranicích zrn.
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.3\textheight]{img/Ferromanganese_metal.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Trikarbonyl(methylcyklopentadienyl)mangan, MMT, se používá jako náhrada tetraethylolova.
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
		\begin{figure}
		\adjincludegraphics[height=0.32\textheight]{img/Manganese-IV_oxide.jpg}
		\end{figure}
		\end{column}
	\begin{column}{.5\textwidth}
		\begin{figure}
			\adjincludegraphics[height=0.32\textheight]{img/Zincbattery.png}
		\end{figure}
	\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{columns}
		\begin{column}{.7\textwidth}
			\begin{figure}
				\adjincludegraphics[height=0.45\textheight]{img/KMnO4_and_glycerol.jpg}
				\caption*{Reakce manganistanu s glycerolem}
			\end{figure}
		\end{column}
		\begin{column}{.3\textwidth}
			\begin{figure}
				\adjincludegraphics[height=0.45\textheight]{img/KMN04-4.jpg}
				\caption*{Rozpouštění \ce{KMnO4} ve vodě}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{itemize}
		...
		\item \ce{2 KMnO4 + 6 HCl + 5 (COOH)2 -> 2 MnCl2 + 10 CO2 + 2 KCl + 8 H2O}
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[width=\textwidth]{img/99Tc_bone_scintigraphy_showed_bull’s_head_sign.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=0.4\textwidth]{img/Illustration_of_Crookes_X-ray_tube.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item \ce{3 Mn + 2 O2 -> Mn3O4}
		\item \ce{3 Mn + N2 -> Mn3N2}
		\item \ce{Mn + Cl2 -> MnCl2}
		\item \ce{4 Mn + 5 F2 -> 2 MnF2 + 2 MnF3}
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=0.4\textwidth]{img/Alpha-MnF4.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		\item Jediným známým binárním halogenidem je fluorid, \ce{MnF3}, který snadno hydrolyzuje, ale termicky je stabilní.
...
\frame{
	...
	\begin{itemize}
		...
		\item \ce{4 MnCl2 + O2 + 20 KCN + 4 HCN -> 4 K3[Mn(CN)6] + 2 H2O + 8 KCl}
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item \ce{MnCO3 + KCN ->[H2O] K4[Mn(CN)6] + K2CO3}
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=0.6\textwidth]{img/Mn2(CO)10.png}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=0.5\textwidth]{img/HMn(CO)5-2D.png}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
		\begin{figure}
			\adjincludegraphics[height=0.5\textwidth]{img/Pentacarbonylhydridomanganese.png}
		\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{itemize}
		...
		\item Oxid rheniový lze připravit redukcí oxidem uhelnatý, oxid technciový nebyl zatím připraven:
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.35\textheight,angle=90]{img/Octachlorodirhenate.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=0.6\textwidth]{img/Re2(CO)10improved.png}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
	\adjincludegraphics[height=0.3\textwidth]{img/Methylrhenium-trioxide-3D-balls.png}
	\end{figure}
	\vfill
}
